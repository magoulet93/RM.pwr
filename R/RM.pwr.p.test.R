...
#' @title RM.pwr.p.test
#'
#' @description This function calculates the effective number of participants in a power analysis for one proportion
#' after considering the effect of the number of measurement for each dependent variable and the intra-
#' class correlation of these measurements.
#'
...
#'
#' @examples
#'# Calculating the effective sample size required for a one proporition.
...
#'
#' @seealso \code{\link[pwr]{pwr.p.test}}
#'
#' @import pwr
#' @export RM.pwr.p.test
...
#############################
# 1. Function for one proportion
#############################

# List of arguments

RM.pwr.p.test <- function(
  h = NULL, # Cohen's h
